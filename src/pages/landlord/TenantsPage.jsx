...
//     const fetch = async () => {
//       try {
//         const res = await api.get('landlord/maintenance-requests/')
...
//     const name = (r.tenant_name || r.name || '').toLowerCase()
//     const property = (r.property || '').toLowerCase()
//     const issue = (r.issue || r.description || '').toLowerCase()
//     const q = searchQuery.toLowerCase()

//     const matchFilter = activeFilter === 'ALL' || r.status?.toUpperCase() === activeFilter
//     const matchSearch = !searchQuery || name.includes(q) || property.includes(q) || issue.includes(q)
...
//                 <th className="p-4 text-left text-sm font-medium text-gray-600">Issue / Request</th>
...
//                   <td className="p-4 font-medium">{r.tenant_name || r.name || '—'}</td>
//                   <td className="p-4">{r.property || '—'}</td>
//                   <td className="p-4">{r.issue || r.description || '—'}</td>
//                   <td className="p-4">
//                     <span className={`px-2 py-1 rounded text-xs font-medium ${
//                       r.status?.toLowerCase() === 'completed' ? 'bg-green-100 text-green-700' :
